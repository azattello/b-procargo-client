...
export const updateSettings = async (
  ...
  whatsappNumber,
  aboutUsText,
  prohibitedItemsText, contractFile, deliveryTime, cargoResponsibility, userId) => {
    ...
    if (cargoResponsibility) formData.append('cargoResponsibility', cargoResponsibility);
